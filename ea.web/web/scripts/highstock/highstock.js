...
(function () {
    ...
    cb = Ga;
    var ib, Z;
    if (!ca && !ia)Highcharts.VMLElement = Z = {init: function (a, b) {
        ...
        return this
    }}, Z = ea(Ca, Z), Z = {Element: Z, isIE8: Ta.indexOf("MSIE 8.0") > -1, init: function (a, b, c) {
        var d, e;
        this.alignedObjects = [];
    ...
    Gb.prototype = {init: function (a, b) {
        ...
        if (l) {
            l = ja(l);
            for (d = l.length; d--;)if (e = a.series[d ? "yAxis" : "xAxis"], l[d] && e)if (h = d ? p(a.stackY, a.y) : a.x, e.isLog && (h = ra(h)), e = e.getPlotLinePath(h, 1), this.crosshairs[d])this.crosshairs[d].attr({d: e,
    ...
    Hb.prototype = {init: function (a, b) {
        ...
        d > c && (d = c);
        if (d > 0)b !== w && $a(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: d === 1 ? h : g}).css({cursor: d ===
    ...
    Sa.prototype = {init: function (a, b) {
        ...
        if (!this.loadingShown)L(c, {opacity: 0, display: "", left: this.plotLeft +
    ...
    $.prototype = {isCartesian: !0, type: "line", pointClass: Ha, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, colorCounter: 0, init: function (a, b) {
        var c, d, e = a.series;
        this.chart = a;
        ...
        getGraphPath: function () {
            ...
            if (d && (f || g))d = pa(this.yAxis.len - this.yAxis.translate(a.threshold || 0)), a = {x: 0, y: 0, width: k, height: d}, k = {x: 0, y: d, width: k, height: k - d}, b.inverted && c.isVML && (a = {x: b.plotWidth - d - b.plotLeft, y: 0, width: e, height: j}, k = {x: d + b.plotLeft - e, y: 0, width: b.plotLeft + d,
    ...
    Ib.prototype = {drawHandle: function (a, b) {
        ...
        if (!isNaN(a)) {
            ...
            if (!this.rendered) {
                ...
                if (v)this.scrollbarGroup = k = f.g("scrollbar").add(), l = s.trackBorderWidth, this.scrollbarTrack = o = f.rect().attr({y: -l % 2 / 2, fill: s.trackBackgroundColor, stroke: s.trackBorderColor, "stroke-width": l,

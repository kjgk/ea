    ...
    Tick.prototype = {
        ...
        render: function (index, old, opacity) {
            ...
            if (label && !isNaN(x)) {
                ...
                if (show && pick(options.showLastLabel, 1) && axis.categories.length - index - 1 < step) {
                    show = false;
                }

                if ((tick.isLast && pick(options.showLastLabel, 1)) || (tick.isFirst && pick(options.showFirstLabel, 1))) {
                    show = true;
                }
                ...
                if (show && !isNaN(xy.y)) {
                    ...
                    label[tick.isNew ? 'attr' : 'animate'](xy);
                    label.element.firstElementChild.style.opacity=0;
                    tick.isNew = false;
                }
            }
        },
            ...
            if (!li) { // generate it once, later move it
                ...
                (useHTML ? li : item.legendGroup).on('mouseover', function () {
                    ...
                    .on('contextmenu', function () {
                        ...
                        fireEvent(item, 'legendItemContextmenu', event, function () {
                        })
                    })
